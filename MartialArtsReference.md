...
* E/e - Elbow (lead/rear), assume horizontal unless specified
...
2. Bob and weave (towards attacker), H, c, H, *half step back* + Pendulum step, RHK->knee/groin
3. *wide c - not hook*, shoulder stop, c, H, c, *half step back* + Pendulum step, RHK->knee/groin
...
* Guard, J, c, H, h, U, u
* Pad Holding
* J, double J, J+c, J+c+H, J+c+H to body+H to head+c, J+H+c, U+u
* Shadowboxing:
	* Only punches
	* All
* Bob & weave
...
1. Horizontal gunting:
	...
	1. Back; scissor motion, Back hand gunting pass->*tricep*, Lead hand push in
1. Vertical gunting:
...
###### Feeding Systems:
	[
		...
		5: jab
		6: backhand heaven jab
		7: heaven jab
		8: Heaven->Earth centerline
		9: Earth crossbody
		10: backhand Earth crossbody
		11: Earth->Heaven centerline (uppercut)
		12: backhand Earth->Heaven centerline (uppercut) 
		All strikes pass through to opposite side, unless marked with (return)
	]
	Inosanto Lacoste:		
	Illustrisimo:
